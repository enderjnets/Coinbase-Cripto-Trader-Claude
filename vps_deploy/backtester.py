...
class Backtester:
    def __init__(self, broker_client=None):
        ...
        # Default to Coinbase if no broker provided (Legacy cleanup)
        if not self.broker:
    ...
    def run_backtest(self, df, risk_level="LOW", initial_balance=10000, strategy_params=None):
        """
        ...
        """
        # Create new strategy instance with custom params
        if strategy_params:
