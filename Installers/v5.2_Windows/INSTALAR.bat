@echo off
REM ============================================================================
REM  BITTRADER WORKER - Instalador Automatico v5.2 - Windows
REM  Haz doble clic en este archivo para instalar.
REM  Compatible con Windows 10/11 (64-bit)
REM
REM  CAMBIOS v5.2:
REM  - Fix critico: re-detecta URL del coordinator en cada inicio.
REM    Funciona desde cualquier red (LAN o Tailscale automaticamente).
REM  - start_workers.bat re-detecta LAN vs Tailscale en cada arranque.
REM ============================================================================
chcp 65001 >nul 2>&1
title Bittrader Worker Installer v5.2

echo.
echo  ╔══════════════════════════════════════════════════════════╗
echo  ║       BITTRADER WORKER INSTALLER v5.2 - Windows         ║
echo  ╚══════════════════════════════════════════════════════════╝
echo.
...
echo INSTALLER_VERSION=5.2
echo LAN_URL=%LAN_URL%
echo WAN_URL=%WAN_URL%
) > config.env

REM ── start_workers.bat: RE-DETECTA URL en cada inicio (fix v5.2) ──
(
echo @echo off
...
echo.
echo  ╔══════════════════════════════════════════════════════════╗
echo  ║          OK  INSTALACION COMPLETADA v5.2                ║
echo  ╚══════════════════════════════════════════════════════════╝
echo.
