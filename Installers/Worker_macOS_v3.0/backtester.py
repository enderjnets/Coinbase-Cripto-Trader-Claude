...
class Backtester:
    ...
    def run_backtest(self, df, risk_level="LOW", initial_balance=10000, strategy_params=None, progress_callback=None, strategy_cls=None):
        ...
        if strategy_cls:
             # If using a specific class (e.g. BitcoinSpotStrategy, DynamicStrategy), instantiate it
             # DynamicStrategy expects genome in constructor
             # BitcoinSpotStrategy might require 'broker_client'
             try:
