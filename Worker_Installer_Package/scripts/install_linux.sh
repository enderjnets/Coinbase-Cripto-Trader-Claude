#!/bin/bash
# ============================================================================
# CRYPTO WORKER INSTALLER - Linux (Ubuntu/Debian)
# ============================================================================

echo "========================================"
echo "  CRYPTO WORKER INSTALLER - Linux"
echo "========================================"
echo ""
...
while true; do
    ...
    COORDINATOR_URL="\$COORDINATOR_URL" PYTHONUNBUFFERED=1 \$VENV_PATH/bin/python -u crypto_worker.py 2>&1 | tee -a "\$LOG_FILE"
...
cat > "$INSTALL_DIR/crypto-worker.service" << EOF
[Unit]
Description=Crypto Strategy Mining Worker
...
echo ""
echo "Para iniciar el worker manualmente:"
...
echo "  sudo cp $INSTALL_DIR/crypto-worker.service /etc/systemd/system/"
echo "  sudo systemctl daemon-reload"
echo "  sudo systemctl enable crypto-worker"
echo "  sudo systemctl start crypto-worker"
echo ""
